...
import 'package:pl_tots/presentation/routes/app_router.dart';
        ...
        ChangeNotifierProvider<PlayerProvider>(
          create: (context) {
            ...
            final List<Player> initialPlayers = [
              Player(id: '1', firstName: 'Lionel', lastName: 'Messi', positions: ['Forward'], image: 'https://dummyimage.com/100x100/000/fff&text=LM'),
              Player(id: '2', firstName: 'Cristiano', lastName: 'Ronaldo', positions: ['Forward'], image: 'https://dummyimage.com/100x100/000/fff&text=CR'),
            ];
